   ...
   $(document)
         .ready(
               function()
               {
                  ...
                  {
                     //alert("positionId test");
                     //alert($("#positionId").val());   //--==>> 2
                  ...
                  $("#submitBtn")
                        .click(
                              function()
                              {
                                 ...
                                 //alert( parseInt($("#minBasicPay").text()) );
                                 //alert( parseInt($("#basicPay").val()) );

                                 // 최소 기본급 유효성 검사
                                 if (parseInt($("#minBasicPay")
                                       .text()) > parseInt($(
                                       "#basicPay").val()))
                                 {
                                    //alert("test");
      ...
      <div id="content">
         ...
         <form action="employeeupdate.action" method="post" id="employeeForm">
            <table>
               <tr>
                  <th>사원번호</th>
                  <td><input type="text" id="employeeId" name="employeeId" readonly="readonly"
               ...
               - <input type="text" id="ssn2" name="ssn2" style="width: 110px;" placeholder="뒷 7자리"></td>
            	</tr>
                  <th>생년월일</th>
               ...
               <tr>
                  ...
                  <td><input type="radio" value="0" name="lunar" id="lunar0"
                     ${employee.lunar==0 ? "checked=\"checked\"" : "" } /> <label for="lunar0">양력</label> 
                     <input type="radio" value="1" name="lunar" id="lunar1"
                     ${employee.lunar==1 ? "checked=\"checked\"" : "" }/> 
                     <label for="lunar1">음력</label></td>
               </tr>
               <tr>
                  <th>전화번호</th>
               ...
               <tr>
                  ...
                  <td><input type="text" id="basicPay" name="basicPay"
                     value="${employee.basicPay }"> (최소 기본급: <span
                     id="minBasicPay" style="color: red; font-weight: bold;">0</span>원)</td>
                     <!--@@@ "${employee.basicPay }"    v   >  큰따옴표 뒤에 공백 있으면 문제생김 주의! } 앞은 상관무 -->
               </tr>
               <tr>
                  <th>수당</th>
               ...
               <tr>
                  <td colspan="2" align="center"><br /> <br />
                     ...
                     <button type="button" id="listBtn" class="btn" style="width: 40%"
                     onclick="location.href='employeelist.action'">직원
                        리스트</button> <br> <br> <span id="err"
