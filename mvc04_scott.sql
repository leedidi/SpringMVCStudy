...
--○ 직원 데이터 조회 쿼리문 구성(직위 데이터 삭제 가능여부 확인)
...
--==>>
/*
EMPLOYEEID NAME      BIRTHDAY   LUNAR TELEPHONE        DEPARTMENTID POSITIONID   REGIONID   BASICPAY   EXTRAPAY SSN1   SSN2                                              
---------- --------- ---------- ----- ---------------- ------------ ---------- ---------- ---------- ---------- ------ --------
...
--==>> 1 행 이(가) 삽입되었습니다.
--> 한 줄 구성
INSERT INTO EMPLOYEE( EMPLOYEEID, NAME, SSN1, SSN2, BIRTHDAY, LUNAR, TELEPHONE, DEPARTMENTID, POSITIONID, REGIONID, BASICPAY, EXTRAPAY ) VALUES( EMPLOYEESEQ.NEXTVAL, '윤유동', '930830', CRYPTPACK.ENCRYPT('2234567', '2234567'), TO_DATE('1993-08-30', 'YYYY-MM-DD'), 0, '010-2944-6341', 1, 1, 1, 1500000, 1500000)
;
...
ROLLBACK;
--==>> 롤백 완료.
--@ 머지 유동언니가없는데..? 나중에 다시해보기. 안나오는게 맞음 생성후 커밋을 단체로 다 안했기때문 ㅋㅋ
